...
`cc-bash-guard verify` explicitly after policy, include, Claude permission, or
binary changes. Stale hook errors include a compact changed-input hint when the
